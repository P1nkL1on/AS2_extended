class anim_block {
	...
	// autoAnimate (target_of_animation : MovieClip)
		static function autoAnimate( who:MovieClip ){
			...
			var str = getByName(who,who.stat+"_start");
			var stp = getByName(who,who.stat+"_stop");
			...
			( who.anim_fix && ((who.direct > 0 && who._currentframe != stp)||(who.direct < 0 && who._currentframe != str)) ))
				{if (who.direct == undefined)animate(who, str, stp,who.anim_spd);//animating
										else animate(who, str, stp,who.anim_spd, who.direct);}
		}
}